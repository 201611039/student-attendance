...
function get(url, asArray) {
  return new Promise(function(resolve, reject) {
    ...
    req.onerror = function() {
      reject(fixError("", "Can't link to local Futronic Web Server. Contact System Administrator"));
    };
...
function onBodyLoad()
{
    ...
    console.log('1');
    sampleNumList = 5;//document.getElementById("sampleNumList
